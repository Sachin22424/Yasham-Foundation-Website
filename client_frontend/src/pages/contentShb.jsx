...
const ContentShb = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            if (id) {
                // Update existing SHB entry
                await axios.put(`https://yasham-foundation-website.onrender.com/api/shb/${id}`, formData);
            } else {
                // Add new SHB entry
                await axios.post('https://yasham-foundation-website.onrender.com/api/shb', formData);
            }
            fetchShbData();
    ...
    return (
        <div className="containercontent mt-5">
            <h1 className="headcontent mb-5 text-center">Work Page 2</h1>
            {loading && <p>Loading...</p>}
